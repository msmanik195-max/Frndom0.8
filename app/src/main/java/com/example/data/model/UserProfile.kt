...
data class UserProfile(
    ...
    val showContactEmail: Boolean = true,
    val showUsername: Boolean = true,
    val showIdCard: Boolean = false,
    val showAddress: Boolean = true,
    val showEducation: Boolean = true,
    val showWork: Boolean = true,
    ...
    val friendsMap: Map<String, Boolean> = emptyMap(),
    val friendRequestsReceivedMap: Map<String, Boolean> = emptyMap(),
    val friendRequestsSentMap: Map<String, Boolean> = emptyMap(),
    ...
    fun toMap(): Map<String, Any> {
        return mapOf(
            ...
            "showContactPhone" to showContactPhone,
            "showContactEmail" to showContactEmail,
            "showUsername" to showUsername,
            "showIdCard" to showIdCard,
            "showAddress" to showAddress,
            "showEducation" to showEducation,
            "showWork" to showWork,
            "showWebsite" to showWebsite,
            ...
            "friendsMap" to friendsMap,
            "friendRequestsReceivedMap" to friendRequestsReceivedMap,
            "friendRequestsSentMap" to friendRequestsSentMap,
